...
namespace WorldDeciding.Infrastructure.Migrations
{
    ...
    [Migration("20260205132735_AddQuestionStatsDaily")]
    partial class AddQuestionStatsDaily
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WorldDeciding.Domain.Entities.Vote", b =>
                {
                    ...
                    b.HasIndex("QuestionId", "IpHash", "VoteDate")
                        .IsUnique();

                    b.HasIndex("QuestionId", "UserId", "VoteDate")
                        .IsUnique();
