...
namespace WorldDeciding.Infrastructure.Migrations
{
    ...
    [Migration("20260303130026_UpdateVoteIndexesForCountryCompare")]
    partial class UpdateVoteIndexesForCountryCompare
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuestionView", b =>
                {
                    ...
                    b.HasIndex("QuestionId", "IpHash", "ViewDate")
                        .IsUnique();

                    b.HasIndex("QuestionId", "UserId", "ViewDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("WorldDeciding.Domain.Entities.QuestionCommentSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("CommentCountAtGeneration")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("QuestionCommentSummaries");
                });
            ...
            modelBuilder.Entity("WorldDeciding.Domain.Entities.Vote", b =>
                {
                    ...
                    b.HasIndex("QuestionId", "CountryCode");

                    b.HasIndex("QuestionId", "IpHash");
                    ...
                    b.HasIndex("QuestionId", "CountryCode", "OptionId");
