...
export default function TiltedCard({
  ...
  return (
    <figure
      ref={ref}
      className="relative h-full w-full [perspective:800px] flex flex-col items-center justify-center"
    ...
    >
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute left-0 top-0 h-full w-full rounded-[18px] object-cover will-change-transform [transform:translateZ(0)]"
      ...
      {showTooltip && (
        <motion.figcaption
          className="pointer-events-none absolute left-0 top-0 hidden rounded-[4px] bg-white px-[10px] py-[4px] text-[10px] text-[#2d2d2d] opacity-0 z-[3] sm:block"
